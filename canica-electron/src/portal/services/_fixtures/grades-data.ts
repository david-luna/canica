...
export const GRADES_LIST = [
  {
    code: 'ASP_PERS',
    name: 'ASPECTES PERSONALS'
  },
  {
    code: 'AMBIT_LING',
    name: 'ÀMBIT LINGÜÍSTIC'
  },
  {
    code: 'LCA1',
  ...
  {
    code: 'AMBIT_MEDI',
    name: 'ÀMBIT DE CONEIXEMENT DEL MEDI'
  },
  {
    code: 'CMN1',
  ...
  {
    code: 'AMBIT_EV',
    name: 'ÀMBIT D\'EDUCACIÓ EN VALORS'
  },
  {
    code: 'VSC1',
