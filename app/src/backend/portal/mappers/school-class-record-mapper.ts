...
import { GradeRecord } from "@/backend/portal/domain/grade-record";

export class SchoolClassRecordMapper {
  static toDataTransfer(
    schoolClassRecord: SchoolClassRecord
  ...
  static toDomain(
    schoolClassRecord: SchoolClassRecordDataTransfer
  ): SchoolClassRecord {
